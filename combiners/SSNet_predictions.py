...
# This function assembles a nested list of the predictions generated by each model on the training and testing data
# The format of the 2D list is [training, testing] where each contains the above for models [a, b, c, d]
# the "split" parameter should be given as "5K"
